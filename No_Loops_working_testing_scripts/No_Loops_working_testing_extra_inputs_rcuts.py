...
outpath = '/work2/08006/dbenton/stampede3/rcuts/quarter_z/'
...
part = gizmo.io.Read.read_snapshots(['star','gas'],'index', 316
...
print('############## outpath check ###############')
print(outpath + 'dense_small_r' + str(316) + '_'+ str(350) + '.txt')
print('############## outpath check ###############')




destined = np.loadtxt(outpath + 'destined_rcuts' + str(316) + '_'+ str(350) + '.txt')
...
small_r_inst_is_dense = []
small_r_inst_is_diffuse = []

mid_r_inst_is_dense = []
mid_r_inst_is_diffuse = []

#big_r_inst_is_dense = []
#big_r_inst_is_diffuse = []

print('############## outpath check ###############')
print(outpath + 'dense_small_r' + str(316) + '_'+ str(350) + '.txt')
print('############## outpath check ###############')

load_small_r_dense = np.loadtxt(outpath + 'dense_small_r' + str(316) + '_'+ str(350) + '.txt')
load_small_r_diffuse = np.loadtxt(outpath + 'diffuse_small_r' + str(316) + '_'+ str(350) + '.txt')

load_mid_r_dense = np.loadtxt(outpath + 'dense_mid_r' + str(316) + '_'+ str(350) + '.txt')
load_mid_r_diffuse = np.loadtxt(outpath + 'diffuse_mid_r' + str(316) + '_'+ str(350) + '.txt')

#load_big_r_dense = np.loadtxt(outpath + 'rcutsdense_big_r' + str(13) + '_'+ str(18) + '.txt')
#load_big_r_diffuse = np.loadtxt(outpath + 'rcutsdiffuse_big_r' + str(13) + '_'+ str(18) + '.txt')
...
for i in range(len(load_small_r_dense)):
    small_r_inst_is_dense.append(load_small_r_dense[i])
                             
for i in range(len(load_small_r_diffuse)):
    small_r_inst_is_diffuse.append(load_small_r_diffuse[i])
    
for i in range(len(load_mid_r_dense)):
    mid_r_inst_is_dense.append(load_mid_r_dense[i])
                             
for i in range(len(load_mid_r_diffuse)):
    mid_r_inst_is_diffuse.append(load_mid_r_diffuse[i])
    
#for i in range(len(load_big_r_dense)):
#    big_r_inst_is_dense.append(load_big_r_dense[i])
                             
#for i in range(len(load_big_r_diffuse)):
#    big_r_inst_is_diffuse.append(load_big_r_diffuse[i])
    ...
    for j in range(len(destined)):
        if destined[j] == 1:
            if den[j,i+1] == 0:
                ...
                if r_0[j] <= 20:
                    small_r_inst_is_dense.append(den[j,0])
                    destined[j] = 0
                    
                elif r_0[j] > 20 and r_0[j] <= 200:
                    mid_r_inst_is_dense.append(den[j,0])
                    destined[j] = 0
                ...
                if r_0[j] <= 20:
                    small_r_inst_is_diffuse.append(den[j,0])
                    destined[j] = 0
                elif r_0[j] > 20 and r_0[j] <= 200:
                    mid_r_inst_is_diffuse.append(den[j,0])
                    destined[j] = 0
                
                
    np.savetxt(outpath + 'ids/' + 'ids_rcuts_' + str(start + i +1) + '.txt', ids[:,i+1])
...
np.savetxt(outpath + 'destined_rcuts' + sstart + '_' + send + '.txt', destined)

np.savetxt(outpath + 'dense_small_r' + outfilename,small_r_inst_is_dense)
np.savetxt(outpath + 'diffuse_small_r' + outfilename,small_r_inst_is_diffuse)

np.savetxt(outpath + 'dense_mid_r' + outfilename,mid_r_inst_is_dense)
np.savetxt(outpath + 'diffuse_mid_r' + outfilename,mid_r_inst_is_diffuse)

#np.savetxt(outpath + 'dense_big_r' + outfilename,big_r_inst_is_dense)
#np.savetxt(outpath + 'diffuse_big_r' + outfilename,big_r_inst_is_dense)
