...
#spherical radial velocities

v_r     = part['gas'].prop('host.velocity.principal.spherical')[:,0]
...
destined = np.loadtxt(outpath + 'destined_velocity_r' + str(258) + '_'+ str(275) + '.txt')
...
inflow_v_r_inst_is_dense = []
inflow_v_r_inst_is_diffuse = []

outflow_v_r_inst_is_dense = []
outflow_v_r_inst_is_diffuse = []
...
load_outflow_v_r_dense = np.loadtxt(outpath + 'dense_outflow_v_r' + str(258) + '_'+ str(275) + '.txt')
load_outflow_v_r_diffuse = np.loadtxt(outpath + 'diffuse_outflow_v_r' + str(258) + '_'+ str(275) + '.txt')

load_inflow_v_R_dense = np.loadtxt(outpath + 'dense_inflow_v_R' + str(258) + '_'+ str(275) + '.txt')
load_inflow_v_R_diffuse = np.loadtxt(outpath + 'diffuse_inflow_v_R' + str(258) + '_'+ str(275) + '.txt')
          
load_dense_ids = np.loadtxt(outpath + 'ids/' + 'dense_ids_velocity_R' + str(258) + '_' + str(275) + '.txt')
load_diffuse_ids = np.loadtxt(outpath + 'ids/' + 'diffuse_ids_velocity_R' + str(258) + '_' + str(275) + '.txt')
...
for i in range(len(load_outflow_v_r_dense)):
    outflow_v_r_inst_is_dense.append(load_outflow_v_r_dense[i])
                             
for i in range(len(load_inflow_v_r_dense)):
    inflow_v_r_inst_is_dense.append(load_inflow_v_r_dense[i])
        
        
for i in range(len(load_outflow_v_r_diffuse)):
    outflow_v_r_inst_is_diffuse.append(load_outflow_v_r_diffuse[i])        
        
for i in range(len(load_inflow_v_r_diffuse)):
    inflow_v_r_inst_is_diffuse.append(load_inflow_v_r_diffuse[i])
        ...
        if destined[j] == 1:
            if (r_0[j] < 20):
                if den[j,i+1] == 0:
                    ...
                    if (v_r[i] > 0):
                        outflow_v_r_inst_is_dense.append(den[j,0])
                        destined[j] = 0
                    elif (v_r[i] < 0):
                        inflow_v_r_inst_is_dense.append(den[j,0])
                        destined[j] = 0
                    ...
                    if (v_r[i] > 0):
                        outflow_v_r_inst_is_diffuse.append(den[j,0])
                        destined[j] = 0
                    elif (v_r[i] < 0):
                        inflow_v_r_inst_is_diffuse.append(den[j,0])
                        destined[j] = 0

    
    
    np.savetxt(outpath + 'ids/' + 'ids_velocity_r' + str(start + i +1) + '.txt', ids[:,i+1])
...
np.savetxt(outpath + 'ids/' + 'dense_ids_velocity_r' + str(start) + '_' + str(end) + '.txt', is_dense)
np.savetxt(outpath + 'ids/' + 'diffuse_ids_velocity_r' + str(start) + '_' + str(end) + '.txt', is_diffuse)
...
np.savetxt(outpath + 'destined_velocity_r' + sstart + '_' + send + '.txt', destined)

np.savetxt(outpath + 'dense_outflow_v_r' + outfilename, outflow_v_r_inst_is_dense)
np.savetxt(outpath + 'diffuse_outflow_v_r' + outfilename, outflow_v_r_inst_is_diffuse)

np.savetxt(outpath + 'dense_inflow_v_r' + outfilename, inflow_v_r_inst_is_dense)
np.savetxt(outpath + 'diffuse_inflow_v_r' + outfilename, inflow_v_r_inst_is_diffuse)
