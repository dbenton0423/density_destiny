...
destined = np.loadtxt(outpath + 'destined_velocity_R' + str(450) + '_'+ str(475) + '.txt')
...
load_outflow_v_R_dense = np.loadtxt(outpath + 'dense_outflow_v_R' + str(450) + '_'+ str(475) + '.txt')
load_outflow_v_R_diffuse = np.loadtxt(outpath + 'diffuse_outflow_v_R' + str(450) + '_'+ str(475) + '.txt')

load_inflow_v_R_dense = np.loadtxt(outpath + 'dense_inflow_v_R' + str(450) + '_'+ str(475) + '.txt')
load_inflow_v_R_diffuse = np.loadtxt(outpath + 'diffuse_inflow_v_R' + str(450) + '_'+ str(475) + '.txt')
          
load_dense_ids = np.loadtxt(outpath + 'ids/' + 'dense_ids_velocity_R' + str(450) + '_' + str(475) + '.txt')
load_diffuse_ids = np.loadtxt(outpath + 'ids/' + 'diffuse_ids_velocity_R' + str(450) + '_' + str(475) + '.txt')
