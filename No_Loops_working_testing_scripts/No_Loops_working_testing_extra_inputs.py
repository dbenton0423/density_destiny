...
destined = np.loadtxt(outpath + 'destined' + str(450) + '_'+ str(475) + '.txt')
...
load_high_dense = np.loadtxt(outpath + 'dense' + str(450) + '_'+ str(475) + '.txt')
load_high_diffuse = np.loadtxt(outpath + 'diffuse' + str(450) + '_'+ str(475) + '.txt')

load_low_dense = np.loadtxt(outpath + 'dense' + str(450) + '_'+ str(475) + '.txt')
load_low_diffuse = np.loadtxt(outpath + 'diffuse' + str(450) + '_'+ str(475) + '.txt')
