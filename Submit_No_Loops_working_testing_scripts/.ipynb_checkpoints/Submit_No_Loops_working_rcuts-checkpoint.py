...
#SBATCH -J 100_200_rcuts         # Job name
#SBATCH -o 100_200_rcuts.out%j     # Name of stdout output file
#SBATCH -e 100_200_rcuts.error%j     # Name of stderr error file
...
No_Loops_working_testing_extra_inputs_rcuts.py 100 200
