...
#SBATCH -J generate_id_locations_quarter_z_feh        # Job name
#SBATCH -o generate_id_locations_quarter_feh.out%j     # Name of stdout output file
#SBATCH -e generate_id_locations_quarter_feh.error%j     # Name of stderr error file
...
python generate_id_locations.py
